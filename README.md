...
Use `/newbot <name> <bot_token> [owner_id]` to create a deployment. The deployed bot then guides owner claim, log group setup, assistant session extraction, and optional support/update/language settings from Telegram.
